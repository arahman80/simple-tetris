...
void add_piece_to_board (unsigned int board[21], unsigned int piece[4][21],
                         int selected_rot);
int fall (unsigned int board[21], unsigned int piece[4][21], int selected_rot);
void shift (unsigned int board[21], unsigned int piece[4][21],
            int selected_rot, int left);
